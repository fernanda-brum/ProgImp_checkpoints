...
function AddAluno(nome_, faltas_, notas_) {
    ...
    this.calcularMedia = () => {
        ...
        // A função reduce recebe um callback como parâmetro que por suas vez recebe outros 2 parâmetros sendo o primeiro o acumulator e o segundo o currentValue (valor do índice atual da iteração do array)
